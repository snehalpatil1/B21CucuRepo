...
public class TestCompareJson {
	...
	public void user_compare_two_json_string(){
		...
		//Case1: Extra field in expected Allowed: PASS
//		String actual1 = "{id:123, name:\"Jerry\", mobile:999}";
//		String expected1 = "{id:123, name:\"Jerry\"}";
//		JSONAssert.assertEquals(expected1, actual1, JSONCompareMode.LENIENT);    //JSONAssert is used for comparing
		//
		//case2 : sequence Change Allowed: PASS
...
//		
//		//Case3: Extra field in expected Not Allowed: FAIL And To Pass case require same no of Attributes in both Actual as well in Expected
...
//		
		//case4 : sequence Change Allowed: PASS   
