...
public class MyPostFromTextFile {
	...
	public void user_hit_the_post_request_with_json_data(String username, String jobValue) throws IOException{
	    ...
	    //Update the data
	    JSONObject object=new JSONObject(data);         //use to update json and jsonpath is use to traverse json element
	    object.put("name", username);                    //update can also called put ,patch.
	    object.put("job", jobValue);
